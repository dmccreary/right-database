...
|---|---------|-------|--------|-------|
| 1 | Concepts | 254 | Required | Concepts from learning graph |
...
| 7 | Glossary Terms | 251 | Recommended | Defined terms in glossary.md |
| 8 | FAQs | 0 | Recommended | Questions in faq.md |
| 9 | Words | 150,383 | Required | Words across student-facing markdown |
...
|-------------|-------------|---------------|-------|
| Diagrams | 58 | 58 | H4 headers starting with '#### Diagram:' |
| Equations | 67 | 25 | LaTeX expressions (inline and display) |
| Total Words | 150,383 | 63,105 | Words in markdown files |
| Links | 288 | 38 | Hyperlinks in markdown format |
| Equivalent Pages | 618 | 269 | Estimated pages (250 words/page + visuals) |
