---
title: ATAM Nine-Step Process Navigator
description: Interactive step-by-step navigator for all nine ATAM steps — select any step to see its phase, participants, activity description, and artifacts produced.
status: implemented
library: html-css-js
bloom_level: 2
bloom_verb: recall
...
# ATAM Nine-Step Process Navigator

<iframe src="main.html" width="100%" height="592" scrolling="no"></iframe>

## Learning Objective

Remembering and Understanding (Bloom's levels 1–2) — students recall all nine ATAM steps in order and understand the purpose, participants, and outputs of each step.

<!-- original scaffold content below -->
